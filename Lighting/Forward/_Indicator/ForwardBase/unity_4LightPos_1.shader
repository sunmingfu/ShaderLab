...
Shader "Tut/Lighting/ForwardBase/Indicator/unity_4LightPos_1" {
	Properties {
	...
	SubShader {
		...
		vertOut vert(appdata_base v)
		{
			...
			float4 lightPos =float4(unity_4LightPosX0[1],unity_4LightPosY0[1],unity_4LightPosZ0[1],1.0);
			float3 toLight=(lightPos-o.pos).xyz;
			float lengthSq = dot(toLight, toLight);
			float atten = 1.0 / (1.0 + lengthSq* unity_4LightAtten0[1]);
